...
\addcontentsline{toc}{section}{Prologue to the Third Contribution}
...
R\'emi Le Priol and Simon Lacoste-Julien started looking for MAP convergence rates while working on \citet{lepriol2021analysis}, as such rates may have been helpful to characterize the speed of adaptation of categorical of multivariate normal models (see the \nth{2} contribution).
About the same time and independently, Frederik Kunstner got interested in this problem while working on \citet{kunstner2020homeomorphic}, a beautiful paper proving that expectation-maximization (EM) in exponential families is an instance of mirror descent. This paper then leveraged recent results on relative smoothness \citep{lu2018relatively} to get the first global convergence rate applicable to EM for Gaussian mixture models. This result naturally raised the question : can we get similar results for stochastic EM via a convergence rate on stochastic mirror descent ? Convergence rate for maximum a posteriori estimates seem to be a prerequisite to answer this question.

Remi and Simon sent calls to the community, looking for answers to this seemingly simple question. That is when the trajectories of R\'emi and Frederik collided, thanks to the mediation of Mark Schmidt. 
...
\begin{figure}[t]
	\centering
\includegraphics[width=.61\textwidth]{gammaMAPrate}
...
\begin{figure*}[t]
	\centering
	\includegraphics[width=\textwidth]{2d/thales_n=3}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=.6\textwidth]{gaussians_bias_variance}
...
\begin{wrapfigure}[12]{l}{0.3\textwidth}
	\centering
	\includegraphics[width=.28\textwidth]{phi}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{optimal_n0}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=.45\textwidth]{2d/logpart}
	\includegraphics[width=.45\textwidth]{2d/entropy}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=.9\textwidth]{2d/mirrormap}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=.9\textwidth]{2d/gaussian_paths}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.4\textwidth]{self_concordance/omega}
	\includegraphics[width=0.4\textwidth]{self_concordance/omega_star}
